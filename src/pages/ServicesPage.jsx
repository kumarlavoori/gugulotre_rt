    ...
    const SERVICES = [
        {
            ...
            desc: "Pixel-perfect, blazing-fast websites and web apps built with React, Next.js, and Django — engineered for SEO, speed, and conversion from day one. Includes custom e-commerce websites and online stores, built with clean architecture that scales with your business.",
            ...
            deliverables: ["Fully responsive website or web app", "Custom e-commerce website / online store", "SEO-optimised page structure", "CMS integration if needed", "Performance audit & optimisation", "Full source code + deployment"],
        },
        {
        ...
        },
        {
            ...
            desc: "One codebase, two platforms. Cross-platform iOS and Android apps with Flutter and React Native that feel native, run fast, and look stunning — including full e-commerce and shopping apps with cart, checkout, and order tracking. From MVP to full App Store launch.",
...
export default function ServicesPage({ setPage, targetService, onServiceHandled, goToContactForm, goToProcessPipeline }) {
    ...
    const MQ1 = ["Web Development", "UI/UX Design", "App Development", "E-Commerce", "Flipkart", "Amazon", "Meesho", "Blinkit", "Instamart", "WordPress & CMS", "Graphic Design", "Fast Delivery", "Pixel Perfect", "Clean Code", "Mobile First"];
    const MQ2 = ["Web Dev", "UI/UX", "App Dev", "E-Commerce", "Marketplace Management", "Flipkart", "Amazon", "Meesho", "Blinkit", "Instamart", "WordPress", "Graphic Design", "Clean Code", "Fast Launch", "Pixel Perfect"];
